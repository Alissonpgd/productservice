 ...
 */
package com.ars.productservice.avro;
...
public class ProductEvent extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  private static final long serialVersionUID = 1934160577769810869L;


  public static final org.apache.avro.Schema SCHEMA$ = new org.apache.avro.Schema.Parser().parse("{\"type\":\"record\",\"name\":\"ProductEvent\",\"namespace\":\"com.ars.productservice.avro\",\"fields\":[{\"name\":\"id\",\"type\":\"string\"},{\"name\":\"name\",\"type\":\"string\"},{\"name\":\"price\",\"type\":\"double\"}]}");
   ...
   */
  public ProductEvent(java.lang.CharSequence id, java.lang.CharSequence name, java.lang.Double price) {
    this.id = id;
    this.name = name;
    this.price = price;
  }
   ...
   */
  public static com.ars.productservice.avro.ProductEvent.Builder newBuilder() {
    return new com.ars.productservice.avro.ProductEvent.Builder();
  }
   ...
   * @return A new ProductEvent RecordBuilder
   */
  public static com.ars.productservice.avro.ProductEvent.Builder newBuilder(com.ars.productservice.avro.ProductEvent.Builder other) {
    if (other == null) {
      return new com.ars.productservice.avro.ProductEvent.Builder();
    } else {
      return new com.ars.productservice.avro.ProductEvent.Builder(other);
    }
  }
   ...
   * @return A new ProductEvent RecordBuilder
   */
  public static com.ars.productservice.avro.ProductEvent.Builder newBuilder(com.ars.productservice.avro.ProductEvent other) {
    if (other == null) {
      return new com.ars.productservice.avro.ProductEvent.Builder();
    } else {
      return new com.ars.productservice.avro.ProductEvent.Builder(other);
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<ProductEvent>
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(com.ars.productservice.avro.ProductEvent.Builder other) {
      super(other);
     ...
     * @param other The existing instance to copy.
     */
    private Builder(com.ars.productservice.avro.ProductEvent other) {
      super(SCHEMA$, MODEL$);
      if (isValidValue(fields()[0], other.id)) {
        this.id = data().deepCopy(fields()[0].schema(), other.id);
    ...
    /**
      ...
      * @return This builder.
      */
    public com.ars.productservice.avro.ProductEvent.Builder setId(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.ars.productservice.avro.ProductEvent.Builder clearId() {
      id = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public com.ars.productservice.avro.ProductEvent.Builder setName(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.ars.productservice.avro.ProductEvent.Builder clearName() {
      name = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public com.ars.productservice.avro.ProductEvent.Builder setPrice(double value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.ars.productservice.avro.ProductEvent.Builder clearPrice() {
